...
test("Adaptive Learning presents explainable learner and per-child parent recommendations",()=>{assert.match(html,/Recommended Next Mission/);assert.match(app,/Why this mission\?/);assert.match(app,/Start Mission/);assert.match(app,/Supported growth areas/);assert.match(app,/recommendation/);});
